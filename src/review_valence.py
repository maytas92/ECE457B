...
class ReviewValence:
	...
	def init_inferencer(self):
		...
		self.review_inferencer = inferencer.Inferencer(self._rule1, self._rule2, self._rule3, self._rule4, 
																									 ...
																									 self._rule13, self._rule14, self._rule15, self._rule16,
																									 self._rule17, self._rule18, self._rule19, self._rule20, 
																									 self._rule21, self._rule22, self._rule23, self._rule24,
																									 self._rule25, self._rule26, self._rule27, self._rule28,
																									 self._rule29, self._rule30, self._rule31, self._rule32,
																									 self._rule33, self._rule34, self._rule35)
